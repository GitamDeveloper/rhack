...
Section:NewButton("invisible fly", "invisible fly", function()
    if nc_d == "up" then
        if nc_oo == true then
...
Section:NewDropdown("invisible fly", "invisible fly direction", {"up", "down","right","left","forward","back",}, function(currentOption)
