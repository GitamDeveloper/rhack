...
--local roomsurv = ReplicatedStorage.GameStats.Player_bloxFac5."1".Knobs."Rooms Survived"
...
Section:NewButton("crack door", "crack door", function()
    for i,v in pairs(game:GetDescendants()) do
...
Section:NewTextBox("tp to door", "tp to name", function(txt_ttd)
    for i,v in pairs(game:GetDescendants()) do
        if v.Name == txt_ttd then
            eplayer.Character.HumanoidRootPart.CFrame = v.Door.Collision.CFrame
        end
    end
end)
